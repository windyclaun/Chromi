...
struct LevelNode: Identifiable, Equatable {
    ...
    static let previewLevels: [LevelNode] = [
        ...
        LevelNode(id: 5, title: "Berry Bay", isUnlocked: false, mapPosition: CGPoint(x: 0.45, y: 0.65)),
        LevelNode(id: 6, title: "Peach Point", isUnlocked: false, mapPosition: CGPoint(x: 0.53, y: 0.42)),
        LevelNode(id: 7, title: "Kiwi Keep", isUnlocked: false, mapPosition: CGPoint(x: 0.64, y: 0.56)),
